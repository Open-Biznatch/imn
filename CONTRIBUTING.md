Contributing to Imn Core
============================

The Imn Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Imn Core project, and is not to be
confused with overall Imn Network Protocol consensus changes.

Whether a pull request is merged into Imn Core rests with the project merge
...
Patches that change Imn consensus rules are considerably more involved than
...
Where a patch set proposes to change the Imn consensus, it must have been
...
The project leader is the release manager for each Imn Core release.
