...
RESOURCES += src/qt/imn.qrc src/qt/imn_locale.qrc

TRANSLATIONS += src/qt/locale/imn_bg.ts \
                src/qt/locale/imn_de.ts \
                src/qt/locale/imn_en.ts \
                src/qt/locale/imn_es.ts \
                src/qt/locale/imn_fi.ts \
                src/qt/locale/imn_fr.ts \
                src/qt/locale/imn_it.ts \
                src/qt/locale/imn_ja.ts \
                src/qt/locale/imn_pl.ts \
                src/qt/locale/imn_pt.ts \
                src/qt/locale/imn_ru.ts \
                src/qt/locale/imn_sk.ts \
                src/qt/locale/imn_sv.ts \
                src/qt/locale/imn_vi.ts \
                src/qt/locale/imn_zh_CN.ts \
                src/qt/locale/imn_zh_TW.ts
