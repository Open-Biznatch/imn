...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Imn features */
        {"imn", "masternode", &masternode, true, true, false},
        {"imn", "listmasternodes", &listmasternodes, true, true, false},
        {"imn", "getmasternodecount", &getmasternodecount, true, true, false},
        {"imn", "masternodeconnect", &masternodeconnect, true, true, false},
        {"imn", "masternodecurrent", &masternodecurrent, true, true, false},
        {"imn", "masternodedebug", &masternodedebug, true, true, false},
        {"imn", "startmasternode", &startmasternode, true, true, false},
        {"imn", "createmasternodekey", &createmasternodekey, true, true, false},
        {"imn", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"imn", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"imn", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"imn", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"imn", "getmasternodescores", &getmasternodescores, true, true, false},
        {"imn", "mnbudget", &mnbudget, true, true, false},
        {"imn", "preparebudget", &preparebudget, true, true, false},
        {"imn", "submitbudget", &submitbudget, true, true, false},
        {"imn", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"imn", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"imn", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"imn", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"imn", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"imn", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"imn", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"imn", "checkbudgets", &checkbudgets, true, true, false},
        {"imn", "mnsync", &mnsync, true, true, false},
        {"imn", "spork", &spork, true, true, false},
        {"imn", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"imn", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use imnd, or the -server option to imn-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> imn-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:36788/\n";
}
