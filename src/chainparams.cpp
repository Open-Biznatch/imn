...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 37788;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Imn starting difficulty is 1 / 2^12
         ...
         *     CTxIn(COutPoint(000000, -1), coinbase 04ffff001d01044c5957697265642030392f4a616e2f323031342054683377884772616e64204578706572696d656e7420476f6573204c6976653a204f76657273746f636b2e636f6d204973204e6f7720416363657074696e6720426974636f696e73)
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Imn: 1 day
        nTargetSpacing = 1 * 60;  // Imn: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        // Testnet imn BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet imn BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet imn BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Imn: 1 day
        nTargetSpacing = 1 * 60;        // Imn: 1 minutes
