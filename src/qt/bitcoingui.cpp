                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Imn Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Imn address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and imn: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zIMN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Imn Core"), this);
    aboutAction->setStatusTip(tr("Show information about Imn Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Imn"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Imn addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Imn addresses"));
    ...
    openAction->setStatusTip(tr("Open a Imn: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Imn Core help message to get a list with possible Imn command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Imn Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Imn network", "", count));
}
...
{
    QString strTitle = tr("Imn Core"); // default title
...
/** Creates context menu, its actions, and imns up all the relevant signals for mouse events. */
