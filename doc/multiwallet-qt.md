...
In order to support loading of multiple wallets in imn-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is imn.cpp.
...
Changes to imn.cpp
----------------------
imn.cpp is the entry point into imn-qt, and as such, will require some minor modifications to provide hooks for
